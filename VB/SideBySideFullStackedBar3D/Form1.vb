...
Namespace SideBySideFullStackedBar3D
    Partial Public Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            Dim series1 As New Series("Series 1", ViewType.SideBySideFullStackedBar3D)
            Dim series2 As New Series("Series 2", ViewType.SideBySideFullStackedBar3D)
            Dim series3 As New Series("Series 3", ViewType.SideBySideFullStackedBar3D)
            Dim series4 As New Series("Series 4", ViewType.SideBySideFullStackedBar3D)
            ...
            CType(series1.View, SideBySideFullStackedBar3DSeriesView).StackedGroup = 0
            CType(series2.View, SideBySideFullStackedBar3DSeriesView).StackedGroup = 0
